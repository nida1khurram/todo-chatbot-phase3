...
export const TaskItem = ({ task, onToggleCompletion, onDelete, onUpdate }: TaskItemProps) => {
  ...
  const [editRecurrenceEndDate, setEditRecurrenceEndDate] = useState(task.recurrence_end_date || '');
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/tasks/${task.id}`, {
        ...
        body: JSON.stringify({
          ...
          recurrence_rule: editRecurrenceRule || undefined,
        ...
        {isEditing ? (
          <div className="space-y-4 animate-fadeIn">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label htmlFor="editTags" className="block text-sm font-medium text-gray-700 mb-1">
                    Tags
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="editRecurrenceRule" className="block text-sm font-medium text-gray-700 mb-1">
                    Recurrence
                  </label>
                  <select
                    id="editRecurrenceRule"
              ...
              {editRecurrenceRule && (
                <div>
                  <label htmlFor="editRecurrenceEndDate" className="block text-sm font-medium text-gray-700 mb-1">
                    Recurrence End Date
                  </label>
                  <input
                    type="date"
