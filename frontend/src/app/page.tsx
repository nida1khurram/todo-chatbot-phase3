...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    if (token) {
      ...
      // If not authenticated, show the colorful landing page
      return;
    }
  }, [router]);
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-indigo-600 mt-2">With Style & Ease</span>
                </h1>
                <p className="mt-3 text-base text-gray-600 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Our beautiful Todo application helps you organize your daily tasks, boost productivity,
                  and achieve your goals. With an intuitive interface and powerful features, staying organized has never been easier.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <div className="h-56 w-full bg-gradient-to-r from-indigo-500 to-purple-600 sm:h-72 md:h-96 lg:w-full lg:h-full flex items-center justify-center">
            <div className="text-white text-center p-8">
              <div className="bg-white bg-opacity-20 backdrop-blur-lg rounded-2xl p-8 max-w-sm mx-auto">
                ...
                <p className="text-sm opacity-90">Organize, prioritize, and complete your tasks efficiently</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our powerful features help you manage your tasks effectively
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mt-5">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Track your progress with beautiful charts and statistics. See how much you&#39;ve accomplished.
                  </p>
                </div>
              </div>
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-3 max-w-xl mx-auto text-xl text-indigo-200 sm:mt-4">
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Join today and transform the way you manage your tasks. Start your journey towards better productivity.
            </p>
            <div className="mt-8 flex justify-center">
              ...
              <div className="ml-3 inline-flex">
                <button
                  onClick={() => router.push('/signup')}
                  className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 transition-all duration-200"
                >
                  Create Account
                </button>
              </div>
