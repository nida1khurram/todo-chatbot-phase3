...
export function TaskProvider({ children }: TaskProviderProps) {
  ...
  const createTask = async (taskData: {
    ...
    const tempTask = {
      ...
      tags: taskData.tags, // Use provided tags or undefined
      recurrence_rule: taskData.recurrence_rule, // Use provided recurrence rule or undefined
      recurrence_end_date: taskData.recurrence_end_date, // Use provided recurrence end date or undefined
    };
